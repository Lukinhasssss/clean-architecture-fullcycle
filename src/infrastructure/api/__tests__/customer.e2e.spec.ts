...
describe('E2E tests for customer', () => {
  ...
  test('should return a list of customers', async () => {
    ...
    expect(listResponseXML.text).toContain('<name>Monkey D Luffy</name>')
    expect(listResponseXML.text).toContain('<name>Roronoa Zoro</name>')
    ...
    expect(listResponseXML.text).toContain('<zipCode>09876-090</zipCode>')
  })
})
